            ...
            <Container className={style.containerTimeLine}>
                <div className={style.timeLine__item}>
                    <div className={style.timeLine__wrapperImg}>
                        <img src='/src/assets/img/about/about-stage-1.webp' alt="" className={style.timeLine__img}/>
                    </div>
                ...
                <div className={style.timeLine__item}>
                    <div className={style.timeLine__wrapperImg}>
                        <img src='/src/assets/img/about/about-stage-2.webp' alt="" className={style.timeLine__img}/>
                    </div>
                    <div className={style.timeLine__wrapperDivider}>
                        <div className={style.timeLine__divider}></div>
                    </div>
                ...
                <div className={style.timeLine__item}>
                    <div className={style.timeLine__wrapperImg}>
                        <img src='/src/assets/img/about/about-stage-3.webp' alt="" className={style.timeLine__img}/>
                    </div>
                    <div className={style.timeLine__wrapperDivider}>
                        <div className={style.timeLine__divider}></div>
                    </div>
                ...
                <div className={style.timeLine__item}>
                    <div className={style.timeLine__wrapperImg}>
                        <img src='/src/assets/img/about/about-stage-4.webp' alt="" className={style.timeLine__img}/>
                    </div>
                    <div className={style.timeLine__wrapperDivider}>
                        <div className={style.timeLine__divider}></div>
                    </div>
                ...
                <div className={style.timeLine__item}>
                    <div className={style.timeLine__wrapperImg}>
                        <img src='/src/assets/img/about/about-stage-5.webp' alt="" className={style.timeLine__img}/>
                    </div>
                    <div className={style.timeLine__wrapperDivider}>
                        <div className={style.timeLine__divider}></div>
                    </div>
