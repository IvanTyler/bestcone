...
import {HomeSliderListType, HomeSliderType} from "../../../../Api/ProjectsData.ts";
import {Container} from "../../../UI/Container/Container.tsx";
import style from './SliderProject.module.scss'
import {Swiper, SwiperSlide} from "swiper/react";
import {Autoplay, EffectFade, Navigation} from "swiper/modules";
import cx from "classnames";
import {ButtonWhite} from "../../../UI/ButtonWhite/ButtonWhite.tsx";
        ...
        <section className={style.sectionSliderProject}>
            <Container className={style.containerSlider}>
                ...
                >
                    ...
                    {dataSlider.length > 1 &&
						<div>
							<div className={cx(style.customButton, style.customButtonPrev)}
								 onClick={handlePrevClick}></div>
							<div className={cx(style.customButton, style.customButtonNext)}
