            ...
            >
                <SwiperSlide className={style.swiperSlide}>
                    <Container className={style.containerSlide}>
                        <img className={style.swiperSlide__img} src={slideImg_1.src} alt="slide_1"/>
                        <div className={style.swiperSlide__inner}>
                            <div className={style.swiperSlide__caption}>
                                ...
                                <div className={cx(style.swiperSlide__captionText, style.swiperCaptionTextSm)}>
                                    <div
                                        className={cx(style.swiperSlide__swiperCaptionTextDecoration, style.scaleInVertical)}></div>
                                ...
                                <ButtonBlue className={style.moreDetails} text='Узнать подробнее' link='/about-us'/>
                            </div>
                        </div>
                    </Container>
                </SwiperSlide>
                ...
                <SwiperSlide className={style.swiperSlide}>
                    <Container className={style.containerSlide}>
                        <img className={style.swiperSlide__img} src={slideImg_2.src} alt="slide_2"/>
                        <div className={style.swiperSlide__inner}>
                            <div className={style.swiperSlide__caption}>
                                <h6 className={style.swiperSlide__title}>
                                    <span
                                        className={cx(style.swiperSlide__wow, style.slideInUp)}>Мы на связи 24/7</span>
                                </h6>
                                <h2 className={style.swiperSlide__subTitle}>
                                    <span className={cx(style.swiperSlide__subTitleText, style.slideInDown)}>
...
export default SwiperSliderBusiness;