    ...
    return (
        <div className={style.documentsItem}>
            <div className={style.documentsItem__iconWrapper}>
                <img src={'/img/object/documents-icon.svg'} alt="" className={style.documentsItem__icon}/>
            </div>
            ...
            <a download className={style.documentsItem__download} href={item.link}>
                ...
                <img src={'/public/icons/download-blue.svg'} alt="" className={style.documentsItem__downloadIcon}/>
            </a>
        </div>
    )
}